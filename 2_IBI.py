import pandas as pd
import numpy as np
df = pd.read_csv("D:\\DTU\\Courses\\02455 Experiment in cognitive science\\data\\Formal data\\2_IBI.csv", skiprows=2, sep=";")
...
# range of indices
visual_task_indices=extract_task_data_indices(start_time=62*60, end_time=63*60,data=data,ibi_start_time=48*60+7)
text_task_indices=extract_task_data_indices(start_time=53*60, end_time=56*60,data=data,ibi_start_time=48*60+7)
