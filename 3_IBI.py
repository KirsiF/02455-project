import pandas as pd
import numpy as np
df = pd.read_csv("D:\\DTU\\Courses\\02455 Experiment in cognitive science\\data\\Formal data\\3_IBI.csv", skiprows=2, sep=";")
...
# range of indices
visual_task_indices=extract_task_data_indices(start_time=35*60, end_time=38*60,data=data,ibi_start_time=31*60+6)
text_task_indices=extract_task_data_indices(start_time=44*60, end_time=47*60,data=data,ibi_start_time=31*60+6)
