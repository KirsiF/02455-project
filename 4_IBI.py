import pandas as pd
import numpy as np
df = pd.read_csv("D:\\DTU\\Courses\\02455 Experiment in cognitive science\\data\\Formal data\\4_IBI.csv", skiprows=2, sep=";")
...
# range of indices
visual_task_indices=extract_task_data_indices(start_time=59*60, end_time=62*60,data=data,ibi_start_time=46*60+55)
text_task_indices=extract_task_data_indices(start_time=51*60, end_time=54*60,data=data,ibi_start_time=46*60+55)
