import pandas as pd
import numpy as np
df = pd.read_csv("D:\\DTU\\Courses\\02455 Experiment in cognitive science\\data\\Formal data\\5_IBI.csv", skiprows=2, sep=";")
...
# range of indices
visual_task_indices=extract_task_data_indices(start_time=38*60, end_time=41*60,data=data,ibi_start_time=26*60+57)
text_task_indices=extract_task_data_indices(start_time=30*60, end_time=33*60,data=data,ibi_start_time=26*60+57)
