import pandas as pd
import numpy as np
df = pd.read_csv("D:\\DTU\\Courses\\02455 Experiment in cognitive science\\data\\Formal data\\6_IBI.csv", skiprows=2, sep=";")
...
# range of indices
visual_task_indices=extract_task_data_indices(start_time=33*60, end_time=36*60,data=data,ibi_start_time=20*60)
text_task_indices=extract_task_data_indices(start_time=24*60, end_time=27*60,data=data,ibi_start_time=20*60)
